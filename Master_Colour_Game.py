...
def check_code(guess, real_code):
    ...
    for guess_color , real_color in zip(guess, real_code):
        # zip method use for take element from list and combine in tupel example :-
        #  guess = ["G","Y"]
        #  real = ["W","R"]
        # zip give the - [("G","W"), ("Y","R")]

        if guess_color == real_color:
            correct_pos += 1
            color_counts[guess_color] -= 1 # when we found correct pos we decress the color_count
